...
exports.main = async (context = {}, sendResponse) => {
  ...
  if (!city || !state || !country) {
    throw new Error('No city or state or country provided');
  }

  if (country == 'RU') {
    throw new Error('Nope (RU).. Sanctions..');
  }
  ...
  {
    type: "alert",
    titleText: "Do you want to learn more about open source weather???",
    bodyText: "You should check out the openweather api at https://api.openweathermap.org",
    variant: "info"
  }
  ]);
